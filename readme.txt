...
#This is small project of node here I have written the code of importing csv file to our mysql database.

#You can run this code and import your csv file to database and also can view the data. I have used server side processing for loading large data in very smooth way.
